...
class MultiHeadAttentionLayer(nn.Module):
    def __init__(self, in_dim, out_dim, num_heads, use_bias):
        ...
        if use_bias:
            self.Q = nn.Linear(in_dim, out_dim * num_heads, bias=True)  # 64, 64
    ...
    def forward(self, g, h, e):
        ...
        g.ndata['Q_h'] = Q_h.view(-1, self.num_heads, self.out_dim) # [4329, 8, 8]
...
class GraphTransformerLayer(nn.Module):
    ...
    def __init__(self, in_dim, out_dim, num_heads, dropout=0.0, layer_norm=False, batch_norm=True, residual=True, use_bias=False):
        ...
        self.in_channels = in_dim       # 64
        self.out_channels = out_dim     # 64
        self.num_heads = num_heads
